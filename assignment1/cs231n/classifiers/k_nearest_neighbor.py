...
class KNearestNeighbor(object):
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            # 2. 对距离排序，返回“排序后的索引”（argsort是按从小到大排）
        # 比如 distances_i = [5,2,8]，argsort后返回 [1,0,2] → 对应距离2、5、8的索引
            sorted_indices = np.argsort(distance_i)

            k_nearest_sorted = sorted_indices[0:k]
            closest_y = self.y_train[k_nearest_sorted]
